...
const vendorCookSteps = [
  {
    ...
    desc: "Craveit gives food vendors who cook real food the visibility they deserve.",
    img: "/images/vendor-cook-illust-1.png",
  },
  {
    title: "Video gets you seen",
    desc: "Your food isn't buried in a menu. It plays as a short video right on people's screens. Customers see exactly what they are buying before they order.",
    img: "/images/vendor-cook-illust-2.png",
  },
  {
    title: "Grow without the guesswork",
    desc: "Track your orders and watch your customer base grow, all from your vendor app.",
    img: "/images/vendor-cook-illust-3.png",
  },
];
...
const vendorReqs = [
  ...
  { title: "A smartphone", desc: "to record short food videos (we'll teach you)" },
  {
    ...
    desc: "downloaded on your phone. Our team will review your application once submitted.",
  },
];
...
const vendorFaqData = [
  {
    ...
    a: "Your earnings are paid directly to your registered Nigerian bank account within 24 hours of each completed and confirmed order.",
  },
  {
    q: "Who handles delivery? Do I need to arrange riders?",
    a: "You do not arrange or pay for delivery. Craveit handles all delivery logistics entirely. When an order comes in you prepare the food and a Craveit rider picks it up and delivers it.",
  },
  {
    q: "What does it cost to sell on Craveit?",
    a: "There is no setup fee. You only pay a small commission on completed orders, and Craveit covers delivery, so you keep more of what you earn.",
  },
  {
    q: "How do I record good food videos?",
    a: "You just need your smartphone. Our team gives you simple guidance on lighting and angles, and most vendors are filming great clips within their first week.",
  },
];
...
const appScreens = [
  {
    title: "Dashboard",
    caption: "See today's sales, orders and rating at a glance the moment you open the app.",
    img: "/images/vendor-dashboard.png",
  },
  {
    title: "Incoming orders",
    caption: "Accept orders in one tap and track every one from kitchen to doorstep.",
    img: "/images/vendor-orders.png",
    toast: true,
  },
  {
    title: "Your menu",
    caption: "Add dishes, set prices and update availability whenever you like.",
    img: "/images/vendor-menu.png",
  },
  {
    title: "Earnings",
    caption: "Watch your weekly earnings grow and get paid the next working day.",
    img: "/images/vendor-earnings.png",
  },
  {
    title: "Payouts",
    caption: "Cash out to your bank account and see every payment clearly itemised.",
    img: "/images/vendor-payout.png",
  },
  {
    title: "Customer reviews",
    caption: "Read what customers say and build a rating that brings in repeat orders.",
    img: "/images/vendor-reviews.png",
  },
  {
    title: "Live chat support",
    caption: "Reach the Craveit team any time you need a hand, right inside the app.",
    img: "/images/vendor-chat.png",
    chat: true,
  },
];
  ...
  return (
    <div className="bg-white text-text-primary font-secondary overflow-x-hidden">
      <PageHero
        ...
        title={
          <>
            Your food. Your <span className="italic text-brand">story</span>. Your income.
          </>
        }
        ...
        illustration={
          <div className="relative w-full max-w-[560px] aspect-[4/3]">
            <div className="absolute inset-0 animate-[vhFloat_5.5s_ease-in-out_infinite]">
              <img
            ...
            <div
              aria-hidden
              className="absolute left-[46%] top-[24%] flex gap-[9px] pointer-events-none"
            >
              <span
                className="w-[7px] h-[26px] rounded-full"
                style={{
                  background: "linear-gradient(#fff,rgba(255,255,255,0))",
                  animation: "vhSteam 2.6s ease-out infinite",
                }}
              />
              <span
                className="w-[7px] h-[26px] rounded-full"
                style={{
                  background: "linear-gradient(#fff,rgba(255,255,255,0))",
                  animation: "vhSteam 2.6s ease-out .5s infinite",
                }}
              />
              <span
                className="w-[7px] h-[26px] rounded-full"
                style={{
                  background: "linear-gradient(#fff,rgba(255,255,255,0))",
                  animation: "vhSteam 2.6s ease-out 1s infinite",
                }}
              />
            </div>
            <span
              aria-hidden
              className="absolute left-[40%] bottom-[26%] w-[14px] h-[14px] rounded-full bg-brand"
              style={{ animation: "vhSpark 1.6s ease-in-out infinite" }}
            />
            <span
              aria-hidden
              className="absolute right-[16%] bottom-[34%] w-[22px] h-[22px] rounded-full border-2 border-brand"
              style={{ animation: "vhRing 2.4s ease-out infinite" }}
            />
          </div>
        }
      >
      ...
      <section className="w-full bg-bg-secondary py-[clamp(64px,9vw,96px)]">
        <div className="craveit-container">
          <SectionHeader
            title={
              <>
                Built for vendors who actually <span className="italic text-brand">cook.</span>
              </>
            }
          />
      ...
      <section className="w-full bg-[#F5F0E8] py-[clamp(64px,9vw,96px)]">
        <div className="craveit-container grid grid-cols-[repeat(auto-fit,minmax(320px,1fr))] gap-[clamp(40px,6vw,64px)] items-center">
          <div data-reveal className="flex flex-col gap-[18px]">
            ...
            <h2 className="font-primary font-semibold text-[clamp(30px,4.2vw,48px)] leading-[1.15] text-text-primary m-0">
          ...
          <div data-reveal className="flex justify-center">
            <div className="relative w-full max-w-[400px] aspect-square">
              <img
                ...
                alt="Vendor requirements checklist"
                className="w-full h-full object-contain"
              />
            </div>
          </div>
        ...
        <div className="craveit-container grid grid-cols-[repeat(auto-fit,minmax(320px,1fr))] gap-[clamp(40px,6vw,64px)]">
          <div data-reveal className="flex flex-col gap-[22px]">
            <h2 className="font-primary font-normal text-[clamp(32px,4.4vw,50px)] leading-[1.08] text-text-primary m-0">
              Questions vendors ask us most
            </h2>
            <p className="font-secondary text-[clamp(15px,1.7vw,22px)] leading-[1.5] text-text-secondary m-0 max-w-[320px]">
      ...
      <CtaBand
        ...
        illustration={
          <div className="relative w-full max-w-[420px] animate-[vhFloat_5.5s_ease-in-out_infinite]">
            <img
              src="/images/cta-hand-phone.png"
              alt="Hand holding phone showing Craveit vendor app"
